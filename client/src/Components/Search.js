...
// function getProducts(searchItem) {
//     var products=[
...
//         }
//         else if(products[i].description.toLowerCase().includes(searchItem.toLowerCase())){
//             searchProducts.push(products[i]);
//         }
//     }
...
//     }
//     else {
//         searchItem=location.state.searchItem;
//     }
//     var products=getProducts(searchItem);
...
export default function Search() {
  ...
  React.useEffect(()=>{populateData();},[searchItem, products])
  // let i=0;
  ...
  async function populateData(){
    ...
    for(var i=0; i<pro.length; i++){
        if(pro[i].name.toLowerCase().includes(searchItem.toLowerCase())){
            searchProducts.push(pro[i]);
        }
        else if(pro[i].description.toLowerCase().includes(searchItem.toLowerCase())){
            searchProducts.push(pro[i]);
        }
    }
